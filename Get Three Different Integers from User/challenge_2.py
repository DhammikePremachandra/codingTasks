...
# Getting input the favorite number of the user and casting it into integer and store the number
...
string_fav_casted = int(string_fav) # This piece of code results a value error becouse string_fav is a string and we cannot cast string into a integer