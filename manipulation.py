# Get a sentence from user and store the user's response in a variable called "str_manip"
...
print(f"Last three characters in backwords: {reverse_last_three}") # Display backwords last three letters
...
# Creating five letter word using "first_three_letters" and "last_two_letters"
