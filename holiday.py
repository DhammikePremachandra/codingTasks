...
while True:
    try: # Error handling
        ...
        # Getting num_nights stay at the hotel as an user input and convert it into integer
...
while True:
    try:# Error handling
        ...
        # Getting rental_days for hiring a car as an user input and convert it into integer
...
def holiday_cost(hotel_cost, plane_cost, car_rental):
    ...
    total_cost_for_holiday = hotel_cost(num_nights) + plane_cost(city_flight) + car_rental(rental_days)
